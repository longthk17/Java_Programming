...
public class MerchandiseGUI extends JPanel{
	...
	private JLabel lb_1, lb_MaLoai, lb_TenLoai, lb_NhaSanXuat, lb_TenSanPham, lb_SoLuong, lb_Gia;
	...
	private void initComponents() {
		...
		lb_1 = new JLabel("Quản Lý Sản Phẩm");
		lb_1.setFont(new Font("Keyes", Font.PLAIN, 20));
		lb_1.setBounds(233, 11, 188, 27);
		
		lb_MaLoai = new JLabel("Mã Loại");
		lb_MaLoai.setFont(new Font("Keyes", Font.PLAIN, 12));
		lb_MaLoai.setBounds(39, 55, 50, 21);
		...
		lb_TenLoai.setFont(new Font("Keyes", Font.PLAIN, 12));
		lb_TenLoai.setBounds(217, 55, 62, 21);
		
		textField_TenLoai = new JTextField();
		textField_TenLoai.setColumns(10);
		textField_TenLoai.setBounds(277, 56, 112, 20);
		...
		btnAdd.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				String Mã  = textField_MaLoai.getText();
			}
		});		
